...
class Exhibition(db.Model):
	...
	parks = db.relationship('Park', secondary='exh_art_park', backref = db.backref('exhibition'))
...
class Park(db.Model):
	...
	exhibitions = db.relationship('Exhibition', secondary='exh_art_park', backref = db.backref('park'))
	artworks = db.relationship('Artwork', secondary='exh_art_park', backref = db.backref('park'))
...
class Artwork(db.Model):
	...
	id = db.Column(db.Integer, primary_key=True)
	name = db.Column(db.String(80))
	exhibitions = db.relationship('Exhibition', secondary='exh_art_park', backref = db.backref('artwork'))
	parks = db.relationship('Park', secondary='exh_art_park', backref = db.backref('artwork'))
	creators = db.relationship('Artist', secondary='artist_artwork', backref='artworks', lazy='dynamic')
...
class Exh_art_park(db.Model):
	...
	# id = db.Column(db.Integer, primary_key=True)
	exhibition_id = db.Column(db.Integer, db.ForeignKey('exhibition.id'), primary_key=True)
...
artist_artwork = db.Table('artist_artwork',
